            ...
            React.createElement("div", { className: "assetage_chart", style: { width: "95%", height: "95%" } },
                React.createElement(recharts_1.ResponsiveContainer, null,
                    React.createElement(recharts_1.PieChart, { width: 1200, height: 1200 },
                        React.createElement(recharts_1.Pie, { data: data, nameKey: "ServiceCategoryName", dataKey: "WRCounts", cx: "50%", cy: "50%", innerRadius: 60, outerRadius: 80, fill: "#c9527b", onClick: handleClick, isAnimationActive: true, activeIndex: activeIndex, onMouseEnter: onMouseEnter }, data.map((entry, index) => React.createElement(recharts_1.Cell, { fill: COLORS[index % COLORS.length] }))),
                        React.createElement(recharts_1.Tooltip, null))),
